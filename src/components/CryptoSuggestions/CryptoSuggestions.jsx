        ...
        if (
            ...
            setSuggestions([
                ...
                },
                {
                    id: parseInt(coinId) + 3,
                    currency: {
                        iconUrl: cryptoDetails4.iconUrl,
                        rank: cryptoDetails4.rank,
                        name: cryptoDetails4.name,
                        marketCap: cryptoDetails4.marketCap,
                        change: cryptoDetails4.change,
                        price: cryptoDetails4.price,
                    },
                    color: '#D0FFF2',
                },
            ]);
