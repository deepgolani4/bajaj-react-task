...
return (
    ...
    <Grid container spacing={1} columns={14} className={styles.cell}>
    ...
    <Grid item xs={2.5} className={styles.logoText}> Crypto Chain </Grid>
    <Grid item xs={3}>
    ...
    <Grid container spacing={1} columns={14} className={styles.cell}>
    <Grid item xs={4.5} className={styles.cell}>
   
    </Grid>
    <Grid item xs={3} href="#">
        <Link href="https://github.com/deepgolani4/bajaj-react-task" underline="none" color="white">
        <item className={styles.first} href="#">Know About Developers</item>
        </Link>
    </Grid>
    <Grid item xs={3}>
    <Link href="/cryptocurrencies" underline="none" color="white">
        <item className={styles.first}>Currencies</item>
        </Link>
    </Grid>
    <Grid item xs={3}>
    <Link href="mailto:abc@xyz.com" underline="none" color="white">
    ...
    <Grid item xs={3}>
    <Link href="https://nz3kqgsyqda.typeform.com/to/Ty8IUsml" underline="none" color="white">
    ...
    <Grid item xs={3}>
    <Link href="https://twitter.com/deepgolani4" underline="none" color="white">
